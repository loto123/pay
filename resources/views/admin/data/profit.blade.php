        ...
        <div class="box-body">
            <form class="form-horizontal" method="post" action="{{Request::url()}}" pjax-container>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" id="parent" name="parent" class="form-control" placeholder="请输入推荐人ID"
                               value="{{$parent}}">
                    </div>
                    <label class="col-sm-1 control-label">运营ID：</label>

                    <div class="col-sm-2">
                        <input type="text" id="operator" name="operator" class="form-control" placeholder="请输入运营ID"
                               value="{{$operator}}">
                    </div>
                </div>
                <div class="form-group">
                                ...
                                <td>
                                    <div class="user-panel clearfix">
                                        ...
                                        <div class="pull-left ml7">
                                            ...
                                            <span>ID:<span
                                                        class="text-yellow">{{$item->operator->username}}</span></span>
                                        </div>
                                    </div>
                                </td>
                            @else
