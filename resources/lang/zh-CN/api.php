...
return [
    ...
    'user_block' => '用户已被冻结',
    'error_shop_status' => '公会不存在或已被关闭',
    'shop_freeze' => '公会已被冻结',
    'error_shop_perm' => '没有操作该公会的权限',
    ...
    'shop_closed' => '公会已关闭',
    'shop_cannot_close' => '当前公会状态不能关闭,请关闭公会交易及交易开关，提现公会余额后重试',
    'shop_exist_member' => '已经是公会成员',
    'error_balance' => '余额不足',
    'error_fund' => '记录不存在',
    'error_pay_password' => '支付密码错误',
    'error_pay_card' => '尚未添加结算卡',
    'error_user_balance' => '用户余额不足',
    'error_mobile_format' => '请填写正确的手机号',
    'error_invite_mobile_format' => '请填写正确的邀请人手机号',
    'user_exist' => '用户已存在',
