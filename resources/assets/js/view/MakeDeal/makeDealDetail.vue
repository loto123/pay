<template>
  <div id="deal-detail">
    <topBack style="background:#eee;">
      <div style="width:100%;
            padding-right:1em;
            box-sizing:border-box;" class="flex flex-reverse" v-if="recordList.length==0 && isManager" @click="cancelTrade">
        撤销任务
      </div>
    </topBack>
    ...
    <passwordPanel :setSwitch="passWordSwitch" :settingPasswordSwitch="false" :secondValid="false" v-on:hidePassword="hidePassword"
    ...
    methods: {
      ...
      init() {
        ...
        if (myDealList != null) {
          ...
          this.recordList = myDealList.record;
          this.shop_id = myDealList.shop_id;
          this.allow_reward = myDealList.allow_reward;
          this.isManager = myDealList.allow_cancel;
          this.status = myDealList.status;
          this.allow_remind = myDealList.allow_remind;
          this.shop_name = myDealList.shop_name;
