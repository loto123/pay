<template>
  <div id="shop">
    <div id="top">
      ...
      <h3 class="money-text">{{total_profit}}
        <i class="diamond" style="margin-left: 0.5em;">&#xe6f9;</i>
      </h3>
      <h3>公会总收益</h3>
    ...
    <div class="shop-list flex flex-justify-around flex-wrap-on">
      ...
      <div class="shop-item flex flex-align-center" @click="goDetail(item.id)" v-for="item in shopList" :key="item.id">
        ...
        <div class="center-box flex-5">
          ...
          <p class="today-earn">今日收益:{{item.today_profit}}
            <i class="diamond">&#xe6f9;</i>
          </p>
          <p class="all-earn">总收益:{{item.total_profit}}
            <i class="diamond">&#xe6f9;</i>
          </p>
        </div>
    ...
    <transition name="slide">
      ...
      <section class="add-shop-tab" v-if="addShopTabStatus">
        ...
        <div class="pay-wrap flex flex-reverse flex-align-center">
          <div class="onsale">推广价:
            <i style="color:red;">￥0</i>
          </div>
          <div class="origin">开店原价:
            <i>￥200</i>
          </div>
        </div>
